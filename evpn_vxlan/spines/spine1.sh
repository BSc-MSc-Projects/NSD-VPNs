...
#net add interface swp3 ip add 10.3.1.2/30
net add loopback lo ip add 4.4.4.4/32

net add ospf router-id 4.4.4.4
net add ospf network 10.1.1.2/30 area 0
net add ospf network 10.2.1.2/30 area 0
#net add ospf network 10.3.1.2/30 area 0
net add ospf network 4.4.4.4/32 area 0
